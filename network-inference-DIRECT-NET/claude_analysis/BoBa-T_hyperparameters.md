...
`../comparisons/domain_shift_diagnostic_low_R2_samples/FINDINGS.md` for the actual results referenced
...
`../comparisons/domain_shift_diagnostic_low_R2_samples/FINDINGS.md` for the full analysis (9 sections,
...
and run for organoid_shGFP/mets_compiled in `../comparisons/domain_shift_diagnostic_low_R2_samples/`
...
4. **Done, at full scale (53 genes x 33 external samples)**: see
   `../comparisons/domain_shift_diagnostic_low_R2_samples/FINDINGS.md` §10. Headline result: per-sample mean
