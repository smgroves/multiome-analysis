...
SPECS = [
    ("gemm_ne1_start", "axis_GEMM_NE1_true_attractor", "GEMM NE1 (true attractor state)", GEMM_WALK_DIR, 7788149757105118,
     "results_RORA_RORB_kd.csv", "RORA_RORB knockdown", "tab:purple"),
    ("gemm_nonne_start_oe", "axis_GEMM_nonNE_true_attractor", "GEMM nonNE (true attractor, shared by Generalist_nonNE/Arc_4)", GEMM_WALK_DIR, 95331434180192,
