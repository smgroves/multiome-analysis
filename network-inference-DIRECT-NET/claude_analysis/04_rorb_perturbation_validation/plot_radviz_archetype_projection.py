...
def main():
    ...
    for ext in ["png", "pdf"]:
        fig.savefig(f"{OUT_DIR}/radviz_archetype_projection_Neuroendocrine1{OUT_SUFFIX}.{ext}", dpi=150)
    plt.close(fig)
    print(f"Wrote {OUT_DIR}/radviz_archetype_projection_Neuroendocrine1{OUT_SUFFIX}.{{png,pdf}}")
