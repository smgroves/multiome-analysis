...
from adaptive_rescale_v2 import build_adaptive_data, classify_genes
...
def main():
    ...
    for name, path in sample_paths.items():
        ...
        adaptive, flagged = build_adaptive_data(raw, normed, nodes, classification=classification)
    ...
    result.to_csv(f"{OUT_DIR}/decisive_test_all_samples_v2.csv", index=False)
    ...
    print(f"\nWrote {OUT_DIR}/decisive_test_all_samples_v2.csv")
